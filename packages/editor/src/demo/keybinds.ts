...
const createSimpleInlineBlockHandler = (type: string) => {
...
const keybinds: KeybindHandler[] = [
  {
    handler: createSimpleInlineBlockHandler('bold'),
    keybind: 'Meta+b',
  },
  {
    handler: createSimpleInlineBlockHandler('italic'),
    keybind: 'Meta+i',
  },
  {
    handler: createSimpleInlineBlockHandler('underline'),
    keybind: 'Meta+u',
  }
];
