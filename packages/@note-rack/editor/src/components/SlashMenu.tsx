...
import type SlashMenuOption from '../types/SlashMenuOption';
import getOffsetCoordinates from '../helpers/getOffsetCoordinates';
import getCursorOffset from '../helpers/caret/getCaretOffset';
import getStringDistance from '../helpers/getStringDistance';
...
/**
 * A slash menu for inserting blocks into the editor.
 * @param props The props for the slash menu.
 * @returns A slash menu for inserting blocks into the editor.
 */
